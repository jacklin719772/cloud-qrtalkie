...
`}</style>
      ...
      {showPayments && createPortal((
        <div style={{ position: 'fixed', inset: 0, zIndex: 2147483647, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center' }} onClick={() => setShowPayments(false)}>
          <div style={{ background: '#111827', borderRadius: '10px', padding: '24px', maxWidth: '700px', width: '90%', height: '65vh', maxHeight: '80vh', display: 'flex', flexDirection: 'column', border: '1px solid #1f2937', boxShadow: '0 20px 60px rgba(0,0,0,0.4)' }} onClick={e => e.stopPropagation()}>
            ...
            {paymentLoading ? <div style={{ textAlign: 'center', padding: '40px', color: '#9ca3af' }}>載入中...</div> : !paymentData ? <div style={{ textAlign: 'center', padding: '40px', color: '#9ca3af' }}>暫無資料</div> : (<>
              ...
              <div style={{ flex: 1, overflow: 'auto', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', minWidth: '550px' }}>
                  <thead><tr style={{ background: '#1a2332' }}><th style={{ padding: '8px 12px', textAlign: 'left', fontWeight: 600, color: '#9ca3af', fontSize: '11px', borderBottom: '1px solid #1f2937', background: '#1a2332' }}>訂單編號</th><th style={{ padding: '8px 12px', textAlign: 'right', fontWeight: 600, color: '#9ca3af', fontSize: '11px', borderBottom: '1px solid #1f2937', background: '#1a2332' }}>金額</th><th style={{ padding: '8px 12px', textAlign: 'left', fontWeight: 600, color: '#9ca3af', fontSize: '11px', borderBottom: '1px solid #1f2937', background: '#1a2332' }}>付款方式</th><th style={{ padding: '8px 12px', textAlign: 'left', fontWeight: 600, color: '#9ca3af', fontSize: '11px', borderBottom: '1px solid #1f2937', background: '#1a2332' }}>付款日期</th><th style={{ padding: '8px 12px', textAlign: 'center', fontWeight: 600, color: '#9ca3af', fontSize: '11px', borderBottom: '1px solid #1f2937', background: '#1a2332' }}>憑證</th></tr></thead>
