      ...
      return (
        <>
          <style>{`
            ...
            .ma-mobile-ecard-wrap * { max-width: 100vw !important; }
            .ma-mobile-ecard-wrap .ecard-form-group { overflow-x: hidden !important; }
            .ma-mobile-ecard-wrap input, .ma-mobile-ecard-wrap select, .ma-mobile-ecard-wrap textarea { max-width: 100% !important; box-sizing: border-box !important; }
          ...
          `}</style>
        <div className="ma-mobile-ecard-wrap" style={{ position: 'fixed', inset: 0, zIndex: 9999, background: '#0f0f10', display: 'flex', flexDirection: 'column', overflowX: 'hidden', overflowY: 'auto', maxWidth: '100vw' }}>
          <div className="ma-ecard-mobile-bar" style={{ flexShrink: 0, display: 'flex', alignItems: 'center', gap: '8px', padding: '0 12px', height: '56px', borderBottom: '1px solid rgba(255,255,255,0.08)', background: '#0f0f10', overflowX: 'hidden' }}>
