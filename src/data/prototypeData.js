export const prototypeUsers = [
  { name: "Alice Chen", username: "alice", status: "online", devices: "2 台", lastSeen: "1 分钟前" },
  { name: "Bob Li", username: "bob", status: "online", devices: "1 台", lastSeen: "4 分钟前" },
  { name: "Support Desk", username: "support", status: "failed", devices: "0 台", lastSeen: "密码错误" },
...
export const legalTexts = {
  terms: {
    title: "服務條款",
    body: `
      <p>以下為 QRTalkie Cloud 服務條款說明，請詳閱後再進行使用。本平台提供租戶管理、帳號註冊與 SIP 服務監控等功能。</p>
      <h3>使用說明</h3>
      <p>使用者應依照本平台提供的功能進行操作，不得進行違規或未授權的行為。</p>
      <h3>服務內容</h3>
      <p>本平台提供即時通訊、SIP 註冊與監控、使用者管理與系統報表等功能。</p>
      <h3>安全責任</h3>
      <p>平台將維護系統安全，但使用者仍需保管帳號與密碼，避免未授權存取。</p>
    `,
  },
  privacy: {
    title: "隱私政策",
    body: `
      <p>本平台重視隱私保護，所有個人資料僅於服務範圍內處理，不會未經授權對外揭露。</p>
      <h3>資料收集</h3>
      <p>僅蒐集提供服務所需資訊，如註冊資料、聯絡資訊與使用紀錄。</p>
      <h3>資料使用</h3>
      <p>資料僅用於帳號管理、客服支援與系統優化，不作其他用途。</p>
      <h3>資料保護</h3>
      <p>平台採取合理技術措施保護資料安全，避免資料外洩與未授權存取。</p>
    `,
  },
};
