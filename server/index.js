  ...
  try {
    ...
    return response.json({
      ...
      data: {
        ...
        coverDataUrl: cc.cover_image_url ? (cc.cover_image_url.startsWith('/') && !cc.cover_image_url.startsWith('/api/') ? `/api${cc.cover_image_url}` : cc.cover_image_url) : '/call-center-images/cc-black-banner.png',
