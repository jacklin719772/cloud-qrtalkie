...
export function buildFreepbxWebrtcExtensionPayloads(extension, email, schema) {
  ...
  return {
    ...
    webrtcConfig: {
      ...
      context: defaults.context,
      maxContacts: defaults.maxContacts,
      disallowCodecs: defaults.disallowCodecs,
      endpointGeneratedExpected: defaults.endpointGeneratedExpected,
      endpointCustomPostOverlay: defaults.endpointCustomPostOverlay,
      endpointCustomPostOverlayFile: defaults.endpointCustomPostOverlayFile || "",
    },
    webrtcPublicConfig: getFreepbxWebrtcPublicConfig(defaults),
