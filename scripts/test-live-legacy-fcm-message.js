...
const liveEnabled = toBool(process.env.PUSH_GATEWAY_LIVE_TEST_ENABLED, false) && toBool(process.env.FCM_LIVE_TEST_ENABLED, false);
const payload = {
  event: "message",
  type: "fcm",
  token,
  ...
  call_id: "",
  msgid: process.env.PUSH_LIVE_TEST_MSGID || "live-fcm-message-001",
  uid: process.env.PUSH_LIVE_TEST_UID || "live-fcm-message-uid",
  sound: process.env.PUSH_LIVE_TEST_SOUND || "default",
  body: process.env.PUSH_LIVE_TEST_BODY || "live fcm message test",
  deliver: liveEnabled,
};
...
console.log(JSON.stringify({
  script: "test-live-legacy-fcm-message",
  url: baseUrl,
  liveEnabled,
