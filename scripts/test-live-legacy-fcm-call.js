...
const payload = {
  ...
  call_id: process.env.PUSH_LIVE_TEST_CALL_ID || "live-fcm-call-001",
  msgid: "",
  uid: process.env.PUSH_LIVE_TEST_UID || "live-fcm-call-uid",
  sound: process.env.PUSH_LIVE_TEST_SOUND || "default",
  body: process.env.PUSH_LIVE_TEST_BODY || "live fcm call test",
  deliver: liveEnabled,
};
...
console.log(JSON.stringify({
  script: "test-live-legacy-fcm-call",
  url: baseUrl,
  liveEnabled,
