...
const payload = {
  ...
  type: "apns",
  token,
  app_id: process.env.PUSH_LIVE_TEST_APP_ID || "com.qrtalkie.push.test.voip",
  ...
  call_id: process.env.PUSH_LIVE_TEST_CALL_ID || "live-apns-call-001",
  msgid: "",
  uid: process.env.PUSH_LIVE_TEST_UID || "live-apns-call-uid",
  sound: process.env.PUSH_LIVE_TEST_SOUND || "default",
  body: process.env.PUSH_LIVE_TEST_BODY || "live apns call test",
  deliver: liveEnabled,
};
...
console.log(JSON.stringify({
  script: "test-live-legacy-apns-call",
  url: baseUrl,
  liveEnabled,
